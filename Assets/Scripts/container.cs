    ...
    public void onSearch() {
        if (!viewed) {
            ...
            if (item < 0) {
                ...
                GameObject.Find("Player").GetComponent<PCtoNPC>().setQuestDone();
            } else {
                switch (Random.Range(0, 100)) {
                    ...
                    case 13:
                        if (gameScripts.cthulu) { temp = "a portal! You release another minion of Cthulu!"; gameScripts.cthulu = true; } else temp = "Cthulu! You release him beginning an era of terror!"; break;
